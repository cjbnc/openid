...
$main::openid_identity_template = "/local/apache22/openid/templates/identity_template.html";
$main::openid_not_found_template = "/local/apache22/openid/htdocs/404.shtml";
$main::openid_login_template = "/local/apache22/openid/templates/login_template.html";
